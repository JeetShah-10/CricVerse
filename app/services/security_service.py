"""
CricVerse Security & Validation Service
...
# Initialize security extensions globally within this module
csrf = CSRFProtect()
limiter: Optional[Limiter] = None # Initialize as Optional, set in init_security
...
def init_security(app: Flask):
    ...
    global limiter # Declare limiter as global to modify the module-level variable
...
def sanitize_string_input(value: str, max_length: int = 255) -> str:
    ...
    value = re.sub(r'[<>"\\]', '', str(value)) # Corrected: escaped backslash
...
def sanitize_search_query(query: str) -> str:
    ...
    dangerous_patterns = [
        ...
        r'(--|#|/\*|\*/)', # Corrected: escaped forward slashes and asterisks
...
class SecurityService:
    ...
    def init_app(self, app: Flask):
        """Initializes Flask extensions and registers error handlers."""
        init_security(app)
        logger.info("✅ SecurityService initialized Flask app components.")

    # Expose common security utilities
    @property
    def encryption_util(self):
...
# Initialize security service instance
